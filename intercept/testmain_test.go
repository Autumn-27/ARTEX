...
// Hold the same advisory lock as db, agent, server and evidence so PG-backed
// tests serialize across packages on the shared dev DB. Without a configured
// database, tests that need PG skip themselves.
